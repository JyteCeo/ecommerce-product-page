window.onload = () => {
    ...
    document.body.style.background = "rgba(255, 125, 26, 0.6)";
    // change it back to default color after 1 second
    setTimeout(function () {
    ...
    // toggle switch for dark mode /background
    let button = document.getElementById('btnn')
    // button.style.border = "3px solid blue";
    button.addEventListener('click', function () {
        // alert('them don click me ')
        let element = document.body
        element.classList.toggle('dark');
        // alert('I learnt a new thing today , Thank Gracious Jesus')
    })
